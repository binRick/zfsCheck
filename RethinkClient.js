...
//            }).
filter(r.row('hostname').eq(os.hostname())).update({os: {hostname: os.hostname(), cpus: os.cpus(), networkInterfaces: os.networkInterfaces(), uptime: os.uptime(), loadavg: os.loadavg(), }}).
        /*
                //    filter(r.row('name').eq('William Adama')).update({
                //        something: '123',
                //    }).
                */
